...
#        ********/********/cgi-bin/cognos.cgi?dsn=********&CAM_action=logonAs&CAMNamespace=********&CAMUsername=*********&CAMPassword=*********&b_action=cognosViewer&ui.action=view&ui.object=defaultOutput(CAMID(%22********%3aa%3a*********%22)%2ffolder%5b%40name%3d%27My%20Folders%27%5d%2fquery%5b%40name%3d%27*******%27%5d)&ui.name=$report&ui.format=CSV
